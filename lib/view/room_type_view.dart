...
class RoomTypeView extends StatefulWidget {
  final double amount;

  const RoomTypeView({Key? key, required this.amount}) : super(key: key);

  @override
  State<RoomTypeView> createState() => _RoomTypeViewState();
}

class _RoomTypeViewState extends State<RoomTypeView> {

  double airconPerson = 5;
  double nonAirconPerson = 1;
  ...
  double amountBeforeDiscount(){
    double totalPerson = airconPerson + nonAirconPerson;
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: Constant.mediumGap,),
              Row(
                children: [
                  Text(
                    "who using ",
